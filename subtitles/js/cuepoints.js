  ...
  Cuepoints.prototype = {
    ...
    getCuePointsByTime: function (ms) {
      ...
      _.each(
        ...
        function (cuepoint) {
          negativemargin =
            cuepoint.negativemargin ||
            GLOBALCONFIGURATION.CUEPOINTSMARGIN.NEGATIVE;
          positivemargin =
            cuepoint.positivemargin ||
            GLOBALCONFIGURATION.CUEPOINTSMARGIN.POSITIVE;
          if (
            ms >= cuepoint.ms - negativemargin &&
            ms < cuepoint.ms + positivemargin
          ) {
            found.push(cuepoint);
          }
        },
